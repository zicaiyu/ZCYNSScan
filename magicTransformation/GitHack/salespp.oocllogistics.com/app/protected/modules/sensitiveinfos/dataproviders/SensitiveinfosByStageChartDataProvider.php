<?php
    ...
    /**
     * Build a data set showing sensitiveinfos grouped by the stage summed by the amount.
     */
    class SensitiveinfosByStageChartDataProvider extends ChartDataProvider
    {
        protected $model;
        ...
        public function getChartData()
        {
            $customFieldData = CustomFieldDataModelUtil::
                               getDataByModelClassNameAndAttributeName('Sensitiveinfo', 'stage');
        ...
        protected static function makeChartSqlQuery()
        {
            ...
            $joinTablesAdapter->addFromTableAndGetAliasName('customfield', 'stage_customfield_id', 'sensitiveinfo');
