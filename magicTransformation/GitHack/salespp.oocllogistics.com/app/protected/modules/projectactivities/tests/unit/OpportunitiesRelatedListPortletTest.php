<?php
    ...
    class ProjectactivitiesRelatedListPortletTest extends ZurmoBaseTest
    {
        ...
        public function testSaveAndRetrievePortlet()
        {
            ...
            $projectactivities = Projectactivity::getByName('superOpp');
            $portlet = new Portlet();
            $portlet->column    = 2;
            $portlet->position  = 5;
            $portlet->layoutId  = 'Test';
            $portlet->collapsed = true;
            $portlet->viewType  = 'ProjectactivitiesForContactRelatedList';
            ...
            $params = array(
                ...
                'relationModel'    => $projectactivities[0],
            ...
            $this->assertEquals('ProjectactivitiesForContactRelatedList', $portlet->viewType);
