<?php
    ...
    /**
     * Build a data set showing projectactivities grouped by the stage summed by the amount.
     */
    class ProjectactivitiesByStageChartDataProvider extends ChartDataProvider
    {
        protected $model;
        ...
        public function getChartData()
        {
            $customFieldData = CustomFieldDataModelUtil::
                               getDataByModelClassNameAndAttributeName('Projectactivity', 'stage');
        ...
        protected static function makeChartSqlQuery()
        {
            ...
            $joinTablesAdapter->addFromTableAndGetAliasName('customfield', 'stage_customfield_id', 'projectactivity');
