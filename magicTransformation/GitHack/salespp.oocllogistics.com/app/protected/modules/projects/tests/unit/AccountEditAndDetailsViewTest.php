<?php
    ...
    class ProjectEditAndDetailsViewTest extends ZurmoBaseTest
    {
        ...
        public function testSetAndGetMetadata()
        {
            ...
            $project = new Project();
            $view = new ProjectEditAndDetailsView('Details', 'whatever', 'whatever', $project);
            $originalMetadata = ProjectEditAndDetailsView::getMetadata($user);
            $metadataIn = $originalMetadata;
            $metadataIn['perUser']['junk1'] = 'stuff1';
            $metadataIn['global'] ['junk2'] = 'stuff2';
            $view->setMetadata($metadataIn, $user);
            $metadataOut = ProjectEditAndDetailsView::getMetadata($user);
