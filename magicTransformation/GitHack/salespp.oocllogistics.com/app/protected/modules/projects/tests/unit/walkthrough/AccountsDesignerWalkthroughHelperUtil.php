<?php
    ...
    class ProjectsDesignerWalkthroughHelperUtil
    {
        ...
        public static function getProjectsMassEditViewLayoutWithAllStandardAndCustomFieldsPlaced()
        {
            return array(
                    'panels' => array(
                        array(
         ...
         */
        public static function fetchProjectsSearchFormGetData()
        {
            return array(
                            'name'               => 'myEditProject',
                            ...
                            'anyPostalCode'      => '95131',
                            'anyCountry'         => 'USA',
                            'anyEmail'           => 'info@myEditProject.com',
        ...
        /**
         * This function returns the necessary get parameters for the project search form
         * based on the project edited data but sets the Multi-select to null value.
         */
        public static function fetchProjectsSearchFormGetDataWithMultiSelectValueSetToNull()
        {
            return array(
                            'name'               => 'myEditProject',
                            'officePhone'        => '259-734-2169',
