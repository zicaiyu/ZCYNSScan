<?php
    ...
    class SensitiveinfoEditAndDetailsViewTest extends ZurmoBaseTest
    {
        ...
        public function testSetAndGetMetadata()
        {
            ...
            $view = new SensitiveinfoEditAndDetailsView('Details', 'whatever', 'whatever', $sensitiveinfo);
            $originalMetadata = SensitiveinfoEditAndDetailsView::getMetadata($user);
            $metadataIn = $originalMetadata;
            $metadataIn['perUser']['junk1'] = 'stuff1';
            $metadataIn['global'] ['junk2'] = 'stuff2';
            $view->setMetadata($metadataIn, $user);
            $metadataOut = SensitiveinfoEditAndDetailsView::getMetadata($user);
