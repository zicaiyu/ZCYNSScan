<?php
    ...
    class SensitiveinfoMappingRuleFormAndElementTypeUtilTest extends ImportBaseTest
    {
        ...
        {
            //Sensitiveinfo
            $attributeImportRules = new SensitiveinfoAttributeImportRules(new ImportModelTestItem(), 'hasOne');
            ...
            //SensitiveinfoDerived
            $attributeImportRules = new SensitiveinfoDerivedAttributeImportRules(new ImportModelTestItem(), 'sensitiveinfoDerived');
            $collection           = MappingRuleFormAndElementTypeUtil::
                                    makeCollectionByAttributeImportRules($attributeImportRules,
                                                                         'sensitiveinfoDerived', 'importColumn');
            $this->assertEquals(2, count($collection));
            $this->assertEquals('ImportMappingRuleDefaultModelNameId', $collection[0]['elementType']);
