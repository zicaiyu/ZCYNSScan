<?php
    ...
    /**
     * Helper functions to assist with testing designer walkthroughs specifically for projectactivity layouts.
     */
    class ProjectactivitiesDesignerWalkthroughHelperUtil
    {
        public static function getProjectactivityEditAndDetailsViewLayoutWithAllCustomFieldsPlaced()
        {
            return array(
                    'panels' => array(
                        array(
        ...
        public static function getProjectactivitiesSearchViewLayoutWithAllCustomFieldsPlaced()
        {
            return array(
                    'panels' => array(
                        array(
         ...
         */
        public static function getProjectactivitiesListViewLayoutWithAllStandardAndCustomFieldsPlaced()
        {
            return array(
                    'panels' => array(
                        array(
        ...
        public static function getProjectactivitiesMassEditViewLayoutWithAllStandardAndCustomFieldsPlaced()
        {
            return array(
                    'panels' => array(
                        array(
        ...
        /**
         * This function returns the necessary get parameters for the projectactivity search form
         * based on the projectactivity edited data.
         */
        public static function fetchProjectactivitiesSearchFormGetData($accountId, $superUserId, $currencyId)
        {
            return array(
