<?php
    ...
    class SensitiveinfosForContactRelatedListView extends SensitiveinfosRelatedListView
    {
            /**
        ...
        public static function getDefaultMetadata()
        {
            ...
            $metadata['global']['toolbar']['elements'][] =
                                ...
                                //currently it will not work correctly since in the db it would store a static value instead of it still being dynamic
                                    ...
                                    'htmlOptions' => array( 'id'   => 'SelectSensitiveinfosForContactFromRelatedListLink',
        ...
        {
            return Zurmo::t('SensitiveinfosModule', 'SensitiveinfosModulePluralLabel For ContactsModuleSingularLabel',
                        LabelUtil::getTranslationParamsForAllModules());
        }

        protected static function resolveAjaxOptionsForSelectList()
        {
            $title = Zurmo::t('SensitiveinfosModule', 'SensitiveinfosModuleSingularLabel Search',
                            LabelUtil::getTranslationParamsForAllModules());
