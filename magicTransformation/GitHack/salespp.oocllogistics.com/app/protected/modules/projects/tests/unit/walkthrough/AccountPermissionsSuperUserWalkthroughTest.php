<?php
    ...
    /**
     * Project Permissions Super User Walkthrough.
     ...
     */
    class ProjectPermissionsSuperUserWalkthroughTest extends ZurmoWalkthroughBaseTest
    {
        ...
        public function testSuperUserDerivedExplicitReadWriteModelPermissionsEditExistingProject()
        {
            ...
            $this->assertEquals(0, count($projects[0]->permissions));
            ...
            $explicitReadWriteModelPermissions = ExplicitReadWriteModelPermissionsUtil::
                                                 makeBySecurableItem(Project::getById($superProjectId));
        ...
        public function testSuperUserDerivedExplicitReadWriteModelPermissionsCreateNewProjects()
        {
            //Set the current user as the super user.
            $super          = $this->logoutCurrentUserLoginNewUserAndGetByUsername('super');
            $group1         = Group::getByName('Group1');
            ...
            //Create a new project with no explicit permissions
            $this->resetGetArray();
            $postData = array('type' => null);
            ...
            //Create a new project with the everyone group explicitly added.
            $this->resetGetArray();
            $postData = array('type' => ExplicitReadWriteModelPermissionsUtil::MIXED_TYPE_EVERYONE_GROUP);
            $this->setPostArray(array('Project' => array(
                                            'name'        => 'myNewProject2',
            ...
            //Create a new project with a non-everyone group explicitly added.
            $this->resetGetArray();
            $postData = array('type' => ExplicitReadWriteModelPermissionsUtil::MIXED_TYPE_NONEVERYONE_GROUP,
                  'nonEveryoneGroup' => $group1->id);
            $this->setPostArray(array('Project' => array(
