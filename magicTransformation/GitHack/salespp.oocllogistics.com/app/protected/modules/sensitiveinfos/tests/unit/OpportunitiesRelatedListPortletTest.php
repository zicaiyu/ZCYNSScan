<?php
    ...
    class SensitiveinfosRelatedListPortletTest extends ZurmoBaseTest
    {
        ...
        public function testSaveAndRetrievePortlet()
        {
            ...
            $sensitiveinfos = Sensitiveinfo::getByName('superOpp');
            $portlet = new Portlet();
            $portlet->column    = 2;
            $portlet->position  = 5;
            $portlet->layoutId  = 'Test';
            $portlet->collapsed = true;
            $portlet->viewType  = 'SensitiveinfosForContactRelatedList';
            ...
            $params = array(
                ...
                'relationModel'    => $sensitiveinfos[0],
            ...
            $this->assertEquals('SensitiveinfosForContactRelatedList', $portlet->viewType);
