<?php
    ...
    /**
     * Form used for selecting an project
     */
    class ProjectSelectForm extends CFormModel
    {
        ...
        {
            return array(
                array('projectId',   'type',    'type' => 'integer'),
        ...
        {
            return array(
                'projectId'          => Zurmo::t('ProjectsModule', 'ProjectsModuleSingularLabel Id',
                                            LabelUtil::getTranslationParamsForAllModules()),
                'projectName'        => Zurmo::t('ProjectsModule', 'ProjectsModuleSingularLabel Name',
                                            LabelUtil::getTranslationParamsForAllModules()),
            );
        }
    }
