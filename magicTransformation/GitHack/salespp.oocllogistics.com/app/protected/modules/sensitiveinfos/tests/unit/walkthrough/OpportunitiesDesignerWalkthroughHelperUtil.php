<?php
    ...
    /**
     * Helper functions to assist with testing designer walkthroughs specifically for sensitiveinfo layouts.
     */
    class SensitiveinfosDesignerWalkthroughHelperUtil
    {
        public static function getSensitiveinfoEditAndDetailsViewLayoutWithAllCustomFieldsPlaced()
        {
            return array(
                    'panels' => array(
                        array(
        ...
        public static function getSensitiveinfosSearchViewLayoutWithAllCustomFieldsPlaced()
        {
            return array(
                    'panels' => array(
                        array(
         ...
         */
        public static function getSensitiveinfosListViewLayoutWithAllStandardAndCustomFieldsPlaced()
        {
            return array(
                    'panels' => array(
                        array(
        ...
        public static function getSensitiveinfosMassEditViewLayoutWithAllStandardAndCustomFieldsPlaced()
        {
            return array(
                    'panels' => array(
                        array(
        ...
        /**
         * This function returns the necessary get parameters for the sensitiveinfo search form
         * based on the sensitiveinfo edited data.
         */
        public static function fetchSensitiveinfosSearchFormGetData($accountId, $superUserId, $currencyId)
        {
            return array(
