<?php
    ...
    abstract class ProjectactivitiesRelatedListView extends SecuredRelatedListView
    {
        public static function getDefaultMetadata()
        {
            $metadata = array(
                'perUser' => array(
                    'title' => "eval:Zurmo::t('ProjectactivitiesModule', 'ProjectactivitiesModulePluralLabel', LabelUtil::getTranslationParamsForAllModules())",
                ),
                'global' => array(
                    //ollzurmo1.1.31
                    'toolbar' => array(
                    ...
                    'rowMenu' => array(
                        'elements' => array(
                            ...
                            array('type'                      => 'RelatedUnlink',
                                  ...
                                  'relationModelRelationName' => 'projectactivities',
                            ...
                            'rows' => array(
                                ...
                                array('cells' =>
                                    array(
                                        array(
                                            'elements' => array(
                                                array('attributeName' => 'activity_date', 'type' => 'Date'),
                                            ),
                                        ),
                                    )
                                ),
        ...
        {
            return 'ProjectactivitiesModule';
        }
    }
?>