<?php
    ...
    class ProjectsRelatedListPortletTest extends ZurmoBaseTest
    {
        ...
        public function testSaveAndRetrievePortlet()
        {
            ...
            $projects = Project::getByName('superProject');
            $portlet = new Portlet();
            $portlet->column    = 2;
            $portlet->position  = 5;
            $portlet->layoutId  = 'Test';
            $portlet->collapsed = true;
            $portlet->viewType  = 'ProjectsForProjectRelatedList';
            ...
            $this->assertEquals('ProjectsForProjectRelatedList', $portlet->viewType);
