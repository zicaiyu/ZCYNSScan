<?php
    ...
    /**
     * Import rules for when an project is not a specific attribute on a model, but most likely a casted down
     ...
     */
    class ProjectDerivedAttributeImportRules extends ModelDerivedAttributeImportRules
    {
        public static function getSanitizerUtilTypesInProcessingOrder()
        {
            return array('ProjectDerivedIdValueType');
        }
    }
?>