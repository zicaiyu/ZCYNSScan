<?php
    ...
    class ProjectactivityMappingRuleFormAndElementTypeUtilTest extends ImportBaseTest
    {
        ...
        {
            //Projectactivity
            $attributeImportRules = new ProjectactivityAttributeImportRules(new ImportModelTestItem(), 'hasOne');
            ...
            //ProjectactivityDerived
            $attributeImportRules = new ProjectactivityDerivedAttributeImportRules(new ImportModelTestItem(), 'projectactivityDerived');
            $collection           = MappingRuleFormAndElementTypeUtil::
                                    makeCollectionByAttributeImportRules($attributeImportRules,
                                                                         'projectactivityDerived', 'importColumn');
            $this->assertEquals(2, count($collection));
            $this->assertEquals('ImportMappingRuleDefaultModelNameId', $collection[0]['elementType']);
