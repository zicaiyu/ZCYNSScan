<?php
    ...
    if (!$freeze)
    {
        ...
        class ProjectReadPermissionsOptimizationScenariosTest extends ProjectReadPermissionsOptimizationBaseTest
        {
            public static function setUpBeforeClass()
            {
                ...
                $u99->username = 'u99.';// that can create projects
    ...
    //            assert('$u3->role->isSame($r4)'); // Not Coding Standard
            ...
            public function testOwnedSecurableItemCreated_Slide2()
            {
                ...
                $this->assertEquals(array(
                                    ...
                                    self::getProjectMungeRows($a1));

                $this->assertTrue(self::projectMungeDoesntChangeWhenRebuilt());
            ...
            public function testRoleDeleted_Slide13()
            {
                ...
                //$this->assertTrue(self::projectMungeDoesntChangeWhenRebuilt()); // Can't do this because
