<?php
    ...
    class ProjectactivitiesChartDataProviderTest extends ZurmoBaseTest
    {
        public static function setUpBeforeClass()
        {
            ...
            ProjectactivityTestHelper::createProjectactivitySourcesIfDoesNotExist();
            $currencies    = Currency::getAll();
            //Make projectactivities for testing chart data.
            $currencyValue = new CurrencyValue();
            $currencyValue->value = 200;
            $currencyValue->currency = $currencies[0];
            $projectactivity = new Projectactivity();
            $projectactivity->owner          = $super;
            $projectactivity->name           = 'abc1';
            $projectactivity->amount         = $currencyValue;
            $projectactivity->closeDate      = '2011-01-01';
            $projectactivity->stage->value   = 'Negotiating';
            $projectactivity->source->value  = 'Outbound';
            assert($projectactivity->save()); // Not Coding Standard
            $currencyValue = new CurrencyValue();
            $currencyValue->value = 350;
            $currencyValue->currency = $currencies[0];
            $projectactivity = new Projectactivity();
            $projectactivity->owner          = $super;
            $projectactivity->name           = 'abc2';
            $projectactivity->amount         = $currencyValue;
            $projectactivity->closeDate      = '2011-01-01';
            $projectactivity->stage->value   = 'Negotiating';
            $projectactivity->source->value  = 'Trade Show';
            assert($projectactivity->save()); // Not Coding Standard
            $currencyValue = new CurrencyValue();
        ...
        {
            $chartDataProvider     = ChartDataProviderFactory::createByType('ProjectactivitiesByStage');
            ...
            $chartDataProvider     = ChartDataProviderFactory::createByType('ProjectactivitiesBySource');
            $chartData             = $chartDataProvider->getChartData();
